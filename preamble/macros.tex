...
% #8 - База практики
\newcommand{\makepracticetitlepage}[8]{%
    \begin{titlepage}
    \thispagestyle{empty}
    \begin{center}
    \MakeUppercase{\textbf{#1}}\\[0.5em] \textbf{#2}\\[1em] \textbf{#3}\\[3em]
    ...
    \end{center}
    \vfill\noindent\hfill
    \begin{tabular}{l} Виконав студент ННІКІТІ: \\ групи: #5 \\ #6 \\[1.5em] Керівник практики від кафедри: \\ \parbox[t]{8cm}{\raggedright #7\strut} \end{tabular}
    \vspace{3em}\begin{center} Рівне – 2026 \end{center}
    \end{titlepage}
}
